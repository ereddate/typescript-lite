...
TypeScript Lite Vite 集成插件，为 Vite 项目提供轻量级的 TypeScript 类型检查功能。

## 📦 安装

```bash
npm install --save-dev tsl-vite-plugin typescript-lite
```
...
**tsl-vite-plugin** - 让 TypeScript 类型检查变得更轻量、更快！